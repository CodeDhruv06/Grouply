...
export default function Profile() {
  ...
  return (
    <div className={`relative min-h-screen overflow-hidden transition-colors duration-500 ${
      isDark ? "bg-gradient-to-b from-[#0f0b06] to-[#1a140c] text-white" : "bg-[var(--bg)] text-[var(--muted)]"
    } p-8`}>
      ...
      <div className="relative z-10 max-w-6xl mx-auto mb-4 flex items-center justify-between">
        <Link
          ...
          className={`inline-flex items-center gap-2 px-3 py-2 rounded-xl border text-sm ${
            isDark ? "border-[#3a2a17] hover:bg-[#2a2015] text-white" : "border-[#e3d3b5] hover:bg-[#fff3e0] text-black"
          }`}
