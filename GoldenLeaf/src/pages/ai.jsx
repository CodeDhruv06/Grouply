  ...
  const processPrompt = async (text) => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE}/gemini/generate`, {
        ...
        body: JSON.stringify({ prompt: text, email: userEmail })
      });
          ...
          <div className="p-4 border-t border-[#3a2a17] bg-[#1a1208]/60">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className={`shrink-0 w-12 h-12 rounded-full grid place-items-center text-xl transition-colors ${
                  isListening ? "bg-red-500" : "bg-[#E86A33]"
                }`}
